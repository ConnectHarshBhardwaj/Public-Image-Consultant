        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-black text-[#0B1A2E] mb-6">
              Establish Your <span className="text-[#1E3A8A]">Political Authority</span>
            </h2>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Political Strategy Call</div>
                  <a href="tel:+919310868777" className="text-2xl font-bold font-heading text-[#0B1A2E] hover:text-[#1E3A8A] transition-colors">
                    +91 93108 68777
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">War Room / Office</div>
                  <a href="https://maps.app.goo.gl/xgfGFxtWkJELTAi17" target="_blank" rel="noopener noreferrer" className="text-lg text-[#0B1A2E] font-medium hover:text-[#1E3A8A] transition-colors block">
