...
export function HeroSection() {
  return (
    ...
    >
      ...
      ></div>
      <div
        className="absolute left-0 bottom-0 w-1/2 h-full opacity-5 pointer-events-none"
        style={{
          background:
            "radial-gradient(circle at bottom left, #1E3A8A 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      ></div>
      ...
      <div className="relative z-10 w-full max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-16 items-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.05] tracking-tight mb-6 font-heading text-[#0B1A2E]">
            ...
            <span className="text-[#1E3A8A]">PR Agency in Narela</span>{" "}
            <br className="hidden lg:block" />& Political Strategy Firm
          </h1>

          <p className="max-w-xl text-lg text-gray-600 mb-10 leading-relaxed font-medium">
            Based in Narela, Hawk Strategies builds powerful political brands,
            winning narratives, media influence, and digital dominance for
            leaders, parties, and public figures.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            <a
              href="/contact"
              className="bg-[#0B1A2E] text-white px-8 py-4 rounded-md font-bold tracking-wide hover:bg-[#1E3A8A] transition-all shadow-md hover:shadow-xl w-full sm:w-auto text-center"
            >
            ...
            <a
              href="/contact"
              className="text-[#0B1A2E] hover:text-[#1E3A8A] transition-colors border border-gray-200 hover:border-gray-400 px-8 py-4 rounded-md font-bold tracking-wide bg-white shadow-sm w-full sm:w-auto text-center"
            >
