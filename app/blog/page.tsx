...
export const metadata: Metadata = {
  title: 'Political War Room Insights (Blog) | Public Image Consultant',
    ...
    <main className="w-full relative pt-20 min-h-screen">
      <div className="py-24 bg-[#050B18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#B22222]/10 border border-[#B22222]/30 mb-8">
            <span className="text-xs sm:text-sm font-semibold tracking-widest uppercase text-[#B22222]">War Room Dispatches</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-white font-heading mb-6 tracking-tight">
            Our <span className="text-[#D4AF37]">Insights</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto text-left">
            <div className="glass-card p-8 rounded-xl border border-white/5 hover:border-[#D4AF37]/30 transition-all duration-300">
              <div className="text-sm text-[#D4AF37] font-bold tracking-widest mb-2 uppercase">May 15, 2024</div>
              ...
              <Link href="#" className="text-sm font-bold text-white uppercase hover:text-[#D4AF37] transition-colors">Read Full Intel →</Link>
            </div>
            
            <div className="glass-card p-8 rounded-xl border border-white/5 hover:border-[#D4AF37]/30 transition-all duration-300">
              <div className="text-sm text-[#D4AF37] font-bold tracking-widest mb-2 uppercase">May 10, 2024</div>
