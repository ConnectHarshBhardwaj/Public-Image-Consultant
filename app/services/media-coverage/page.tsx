...
export const metadata: Metadata = {
  ...
  description:
    "Premium media syndication and strategic local news coverage for political leaders in Delhi.",
};
      ...
      <section className="py-24 bg-[#FAFAFA] relative border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 leading-relaxed mb-10">
            Exclusive syndication across regional and national media channels to
            control the narrative. We secure strategic press coverage, manage TV
            interviews, and enhance brand visibility for political and public
            figures.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-[#0B1A2E] mb-6">
                Controlling the{" "}
                <span className="text-[#1E3A8A]">News Cycle</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                Positive media visibility is not an accident; it is engineered.
                Hawk Strategies maintains an extensive network of relationships
                with journalists, editors, and producers across print, digital,
                and broadcast media.
              </p>
              <p className="text-gray-600 leading-relaxed">
                We don&apos;t just secure coverage; we shape the angle of the
                story. Whether you need strategic press release distribution,
                placements in leading national dailies, or prime-time TV
                visibility, our Media PR team ensures your message reaches the
                masses with authority.
              </p>
            </div>
              ...
              {[
                {
                  icon: Newspaper,
                  title: "Print Media",
                  desc: "Placements in major national and regional newspapers.",
                },
                {
                  icon: Tv,
                  title: "Broadcast TV",
                  desc: "Securing prime-time coverage and panel appearances.",
                },
                {
                  icon: Globe,
                  title: "Digital News",
                  desc: "Syndication across high-authority digital news portals.",
                },
                {
                  icon: Mic,
                  title: "Interview Prep",
                  desc: "Media training and debate preparation for leaders.",
                },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="mb-24">
            <h2 className="text-3xl font-heading font-bold text-[#0B1A2E] text-center mb-12">
              Our Syndication <span className="text-[#1E3A8A]">Network</span>
            </h2>
              ...
              {[
                {
                  ...
                  desc: "Writing compelling press releases and statement drafts tailored to journalistic standards.",
                },
                {
                  step: "02",
                  title: "Targeted Pitching",
                  desc: "Leveraging our media network to push stories to relevant reporters and editors.",
                },
                {
                  step: "03",
                  title: "Coverage Tracking",
                  desc: "Monitoring the news cycle and compiling detailed PR impact reports for your campaign.",
                },
              ].map((phase, idx) => (
                <div
                  key={idx}
          ...
          <div className="bg-white border border-[#1E3A8A]/10 p-8 md:p-12 rounded-xl text-center shadow-sm">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8">
              Establish undeniable credibility through strategic news
              placements. We connect leaders directly to the media platforms
              that matter most.
            </p>
            <Link
              href="/contact"
