      ...
      <section className="py-24 bg-[#FAFAFA] relative border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1E3A8A]/5 border border-[#1E3A8A]/20 mb-8">
            <span className="text-xs sm:text-sm font-bold tracking-widest uppercase text-[#1E3A8A]">Strategic Intelligence</span>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-[#0B1A2E] mb-6">Master the Electorate with <span className="text-[#1E3A8A]">Granular Intelligence</span></h2>
          ...
          {/* Workflow/Process */}
          <div className="mb-24">
             <h2 className="text-3xl font-heading font-bold text-[#0B1A2E] text-center mb-12">Data Integration <span className="text-[#1E3A8A]">Workflow</span></h2>
             <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  ...
                  <div key={idx} className="relative p-6 border border-gray-100 bg-[#FAFAFA] rounded-md shadow-sm overflow-hidden text-center md:text-left">
