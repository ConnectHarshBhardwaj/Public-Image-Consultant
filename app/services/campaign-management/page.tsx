...
export const metadata: Metadata = {
  ...
  description:
    "Data-driven and high-impact political campaign management covering booth-level strategy to elite reputation PR.",
};
      ...
      <section className="py-24 bg-[#FAFAFA] relative border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 leading-relaxed mb-10">
            End-to-end command center operations for modern elections. We
            architect undeniable victories through strategic engineering,
            offline mobilization, and digital dominance.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-[#0B1A2E] mb-6">
                Orchestrating{" "}
                <span className="text-[#1E3A8A]">Electoral Success</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                A successful political campaign requires more than just mass
                appeal; it demands tactical execution at every level. Hawk
                Strategies acts as your central command, translating
                macro-political vision into micro-level operational reality.
              </p>
              <p className="text-gray-600 leading-relaxed">
                From organizing high-impact rallies to executing stealthy
                booth-level mobilization, our Campaign Management division
                integrates traditional political groundwork with high-tech
                digital amplification to ensure comprehensive narrative
                dominance.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Comprehensive macro and micro strategy development.",
                },
                {
                  icon: Flag,
                  title: "Rally Management",
                  desc: "Executing massive on-ground events and roadshows.",
                },
                {
                  icon: Target,
                  title: "Ground Coordination",
                  desc: "Cadre mobilization and booth-level worker alignment.",
                },
                {
                  icon: Activity,
                  title: "Voter Engagement",
                  desc: "Omnichannel outreach and sentiment driving.",
                },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="bg-white border border-[#1E3A8A]/10 shadow-sm p-8 md:p-12 rounded-xl text-center mb-24">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8">
              We don&apos;t accept standard campaigns. We run highly structured
              corporate-style political operations designed for maximum
              efficiency and electoral output.
            </p>
            <Link
              href="/contact"
