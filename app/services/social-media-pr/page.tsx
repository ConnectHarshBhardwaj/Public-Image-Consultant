...
export const metadata: Metadata = {
  ...
  description:
    "Dominate the digital ecosystem with elite social media PR strategies designed for political leaders.",
};
      ...
      <section className="py-24 bg-[#FAFAFA] relative border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 leading-relaxed mb-10">
            Algorithmic domination and viral narrative engineering. We manage
            political digital campaigns, audience engagement, and social brands
            across Instagram, Facebook, YouTube, and X.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-[#0B1A2E] mb-6">
                Mastering the{" "}
                <span className="text-[#1E3A8A]">Algorithmic Battlefield</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                Elections are won and lost on the screens of smartphones. Hawk
                Strategies operates specialized Social Media War Rooms that
                treat digital PR not as an afterthought, but as the primary
                theater of political engagement.
              </p>
              <p className="text-gray-600 leading-relaxed">
                From launching viral hashtags on X (Twitter) to crafting
                compelling short-form video content for Instagram Reels and
                YouTube Shorts, our digital strategists ensure your political
                message achieves maximum organic and paid reach.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Crafting a unified, powerful political persona online.",
                },
                {
                  icon: TrendingUp,
                  title: "Viral Strategies",
                  desc: "Engineering content designed to break the algorithms.",
                },
                {
                  icon: Share2,
                  title: "Platform Management",
                  desc: "End-to-end operation of Facebook, X, Instagram & YT.",
                },
                {
                  icon: Users,
                  title: "Audience Growth",
                  desc: "Data-driven tactics to expand your digital follower base.",
                },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="mb-24">
            <h2 className="text-3xl font-heading font-bold text-[#0B1A2E] text-center mb-12">
              Digital <span className="text-[#1E3A8A]">Execution Model</span>
            </h2>
              ...
              {[
                {
                  ...
                  desc: "Sourcing daily updates, speeches, and ground-level political activities.",
                },
                {
                  step: "02",
                  title: "Studio Production",
                  desc: "High-end editing of video and graphic content optimized for each platform.",
                },
                {
                  step: "03",
                  title: "War Room Deployment",
                  desc: "Coordinated releasing and boosting of content to hijack trending topics.",
                },
                {
                  step: "04",
                  title: "Analytics & Adjustment",
                  desc: "Real-time monitoring of engagement metrics to refine future content strategy.",
                },
              ].map((phase, idx) => (
                <div
                  key={idx}
                  className="relative p-6 border border-gray-100 bg-[#FAFAFA] shadow-sm rounded-md overflow-hidden text-center md:text-left"
                >
          ...
          <div className="bg-white border border-[#1E3A8A]/10 p-8 md:p-12 rounded-xl text-center shadow-sm">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8">
              Our digital strategists understand the specific nuances of Indian
              political social media. We create content that resonates,
              provokes, and mobilizes.
            </p>
            <Link
              href="/contact"
