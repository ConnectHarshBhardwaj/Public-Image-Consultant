...
export const metadata: Metadata = {
  title: 'Case Studies | Public Image Consultant Delhi',
      ...
      <div className="py-24 bg-[#050B18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 mb-8">
            <span className="text-xs sm:text-sm font-semibold tracking-widest uppercase text-[#D4AF37]">Classified Victories</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto text-left">
            <div className="glass-card p-8 rounded-xl border border-white/5 hover:border-[#D4AF37]/30 transition-all duration-300">
              <div className="text-sm text-[#D4AF37] font-bold tracking-widest mb-2 uppercase">2023 Municipal Elections</div>
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300 flex items-center gap-2"><span className="text-[#D4AF37]">•</span> +450% Digital Reach</li>
                <li className="text-gray-300 flex items-center gap-2"><span className="text-[#D4AF37]">•</span> 42 Dedicated Viral Audio Tracks</li>
              </ul>
              <Link href="/contact" className="text-sm font-bold text-white uppercase hover:text-[#D4AF37] transition-colors">Discuss Strategy →</Link>
            </div>
            
            <div className="glass-card p-8 rounded-xl border border-white/5 hover:border-[#D4AF37]/30 transition-all duration-300">
              <div className="text-sm text-[#D4AF37] font-bold tracking-widest mb-2 uppercase">Crisis Management</div>
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300 flex items-center gap-2"><span className="text-[#D4AF37]">•</span> 15+ Favorable Mainstream Editorials</li>
                <li className="text-gray-300 flex items-center gap-2"><span className="text-[#D4AF37]">•</span> 100% Core Base Retention</li>
              </ul>
              <Link href="/contact" className="text-sm font-bold text-white uppercase hover:text-[#D4AF37] transition-colors">Discuss Strategy →</Link>
            </div>
          </div>
